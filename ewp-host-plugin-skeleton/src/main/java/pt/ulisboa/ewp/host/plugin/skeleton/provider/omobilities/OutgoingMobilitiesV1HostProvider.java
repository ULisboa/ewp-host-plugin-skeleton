 ...
 */
public abstract class OutgoingMobilitiesV1HostProvider extends HostVersionedProvider {
    ...
    public abstract Collection<String> findOutgoingMobilityIds(
        ...
        @Nullable Collection<String> receivingHeiIds,
        @Nullable String receivingAcademicYearId, @Nullable LocalDateTime modifiedSince);

    /**
     * Returns a collection of Outgoing Mobilities given their IDs. If some ID is unknown then it
     * must be ignored.
     *
     * @param requesterCoveredHeiIds List of HEI IDs covered by the requester. The result should be
     *                               restricted to the mobilities to which some covered HEI ID has
